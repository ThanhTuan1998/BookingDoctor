...
import { saveBulkScheDoctor } from "../../../services/userService";
class ManageSchedule extends Component {
  ...
  handleChangeSelect = async (selecttedOption) => {
    this.setState({ selectedDoctor: selecttedOption });
  };
  ...
  handleSaveSchedule = async () => {
    ...
    if (selectedDoctor && _.isEmpty(selectedDoctor)) {
      toast.error("Invalid selected doctors! ");
      return;
    }
    ...
    let res = await saveBulkScheDoctor({
      arrSchedule: result,
